...
fn main() {
    ...
    if let Err(error) = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::archive_market_plugin,
            commands::publish_draft,
            commands::publish_plugin_draft,
            ...
            commands::set_plugin_binding_enabled,
            commands::upgrade_skill_binding,
            commands::upgrade_plugin_binding,
